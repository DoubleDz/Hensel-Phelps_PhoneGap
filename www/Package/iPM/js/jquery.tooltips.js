	...
	var methods = {
		init : function(options) {
			var defaults = {
				...
				tip_delay_time : 400, 			// tooltip delay before displaying: milliseconds
			...
			function smtGetCursorCoords(event) {
				var smtCursorCoordsX = event.pageX, smtCursorCoordsY = event.pageY;
			...
			return this["live"]("mouseover", function(event) {
				var $this = $(this), title = $this.attr(options.attribute);
